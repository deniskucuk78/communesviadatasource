...
/**
 * Servlet implementation class RechercheCommunesParDepartementServlet
 */
@WebServlet("/RechercheCommunesParDepartementServlet")
public class RechercheCommunesParDepartementServlet extends HttpServlet {
